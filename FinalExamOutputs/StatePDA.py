...
class State:
    def __init__(self, representation: str):
        ...
        self.string_representation: str = (
            representation  # String representation of the name of the state
        )
    ...
    def delta(self, input_symbol: str, pop_symbol: str) -> Transition | None:
        ...
        for transition in self.transitions:
            if (
                ...
                and transition.pop_symbol == pop_symbol
            ):
                return transition
        return None
    ...
    def set_transition(
        self,
        input_symbol: str,
        stack_pop_symbol: str,
        next_state: Self,
        stack_push_symbols: str,
    ) -> None:
        ...
        self.transitions.append(
            Transition(
                self, input_symbol, stack_pop_symbol, next_state, stack_push_symbols
            )
        )
